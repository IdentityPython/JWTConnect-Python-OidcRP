...
class AccessToken(access_token.AccessToken):
    ...
    def __init__(self,
                 get_service_context, get_services,
                 client_authn_factory=None,
                 conf: Optional[dict]=None):
        access_token.AccessToken.__init__(self, get_service_context, get_services,
    ...
    def get_authn_method(self):
        try:
            return self.get_service_context().behaviour['token_endpoint_auth_method']
        except KeyError:
