...
def test_conversation():
    ...
    assert set(entity.get_services().keys()) == {'accesstoken', 'authorization', 'webfinger',
    ...
    entity.get_service_context().issuer = OP_BASEURL
    ...
    _pi = entity.get_service_context().provider_info
