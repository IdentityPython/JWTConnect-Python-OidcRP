...
class TestPKCE256:
    ...
    def test_add_code_challenge_default_values(self):
        ...
        _state_key = self.entity.get_service_context().state.create_state(iss="Issuer")
    ...
    def test_authorization_and_pkce(self):
        auth_serv = self.entity.get_service("authorization")
        _state = self.entity.get_service_context().state.create_state(iss='Issuer')
    ...
    def test_access_token_and_pkce(self):
        ...
        self.entity.get_service_context().state.store_item(auth_response, 'auth_response', _state)
