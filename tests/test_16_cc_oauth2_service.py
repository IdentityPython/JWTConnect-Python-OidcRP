...
class TestRP():
    ...
    def create_service(self):
        ...
        self.entity.entity_get("service",'accesstoken').endpoint = 'https://example.com/token'
        self.entity.entity_get("service",'refresh_token').endpoint = 'https://example.com/token'

    def test_token_get_request(self):
        request_args = {'grant_type': 'client_credentials'}
        _srv = self.entity.entity_get("service",'accesstoken')
    ...
    def test_token_parse_response(self):
        ...
        info = _srv.entity_get("service_context").state.get_item(AccessTokenResponse, 'token_response', _key)
    ...
    def test_refresh_token_get_request(self):
        ...
        _srv = self.entity.entity_get("service",'refresh_token')
        _id = rndstr(16)
